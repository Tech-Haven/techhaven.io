...
const Footer = () => (
  <footer className='container mx-auto mt-auto mb-4 text-gray-200'>
    <div className='grid grid-cols-1 divide-y divide-gray-600'>
      {/* Top Section */}
      <div className='flex flex-row gap-x-1 justify-center pb-4'>
        <p>Self-hosted with</p>
        <svg
      ...
      <div className='flex flex-row justify-between pt-4'>
        ...
        <div className='flex flex-row gap-4'>
          ...
          <a href='https://github.com/Tech-Haven'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='24'
              height='24'
          ...
          <a href='https://www.youtube.com/channel/UCv3nmebO26paOxIuQ5jfLWg'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='24'
              height='24'
